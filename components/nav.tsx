...
export default function NavBarComponent(){
    return (
        <nav className="fixed top-0 w-screen left-0 right-0 z-50 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center justify-center ">
              <Link href="/" className="flex-shrink-0 flex space-x-2">
                <Home className="h-8 w-8" /> 
                <div className="font-bold text-md md:text-2xl">Japanese Guide of guides</div>
              </Link>
